...
contract Battle is Timed {
    ...
    uint256 public constant maxPersians = 300000 * 10**18;  // 300.000
    ...
    event WarriorsBackToHome(address indexed to, address faction, uint256 warriors);

    /*******************************************************************************************
    When the battle ends in a draw:
        (*) 10% of troops of both sides lie on the ground
        (*) 90% of them will be sent back to the former owner
        (*) No slaves are assigned
    When the battle ends with a winner:
        (*) 10% of troops of both sides lie on the ground
        (*) 90% of them will be sent back to the former owner
        (*) Surviving slaves are assigned to winner
    *******************************************************************************************/
