...
contract('BattleOfThermopylae', function (accounts) {
    ...
    describe("Greeks won!", async function () {
        ...
        ******************************************************************************/
        ...
        it('Should redeem survived Spartan warriors and Persian slaves', async function () {
        ...
        it('Can\'t redeem Spartan warriors and Persian slaves twice', async function () {
            let player = spartan_1;
        ...
        it('Should redeem all Athenians and Persian slaves', async function () {
        ...
        it('Can\'t redeem Athenian warriors and Persian slaves twice', async function () {
            let player = athenian_1;
            // Redeem warriors again        
            let redeem = await battle.redeemWarriors({ from: player });
            assert(redeem, 'Redeem failed');
        ...
        it('Should redeem survived Spartans, Persian slaves, all Athenians and all Immortals', async function () {
        ...
        it('Can\'t redeem survived Spartans, Persian slaves, all Athenians and all Immortals twice', async function () {
            let player = all_warriors_1;
            // Redeem warriors again        
            let redeem = await battle.redeemWarriors({ from: player });
            assert(redeem, 'Redeem failed');
        ...
        it('Can\'t redeem Persians', async function () {
        ...
        it('Should redeem all Immortals without Spartan slaves', async function () {
    ...
    describe("Persians won!", async function () {
        ...
        ******************************************************************************/
        ...
        it('Should redeem survived Persian warriors and Spartan slaves', async function () {
            let player = persian_1;
            // Check balances
            let currentPersiansBalance = await persians.balanceOf(player);
            let currentSpartansBalance = await spartans.balanceOf(player);
        ...
        it('Can\'t redeem Persian warriors and Spartan slaves twice', async function () {
            let player = persian_1;
            // Redeem warriors again
            let redeem = await battle.redeemWarriors({ from: player });
            assert(redeem, 'Redeem failed');
        ...
        it('Should redeem all Immortals and Spartan slaves', async function () {
            let player = immortal_1;
            // Check balances
            let currentImmortalsBalance = await immortals.balanceOf(player);
            let currentSpartansBalance = await spartans.balanceOf(player);
        ...
        it('Can\'t redeem Immortal warriors and Persian slaves twice', async function () {
            let player = immortal_1;
            // Redeem warriors again        
            let redeem = await battle.redeemWarriors({ from: player });
            assert(redeem, 'Redeem failed');
        ...
        it('Should redeem survived Persians, Spartan slaves, all Immortals and all Athenians', async function () {
            let player = all_warriors_1;
            // Check balances        
            let currentPersiansBalance = await persians.balanceOf(player);
            let currentSpartansBalance = await spartans.balanceOf(player);
        ...
        it('Can\'t redeem survived Persians, Spartan slaves, all Immortals and all Athenians twice', async function () {
            let player = all_warriors_1;
            // Redeem warriors again        
            let redeem = await battle.redeemWarriors({ from: player });
            assert(redeem, 'Redeem failed');
        ...
        it('Can\'t redeem Spartans', async function () {
            let player = spartan_1;
            // Check balances
            let currentPersiansBalance = await persians.balanceOf(player);
            let currentSpartansBalance = await spartans.balanceOf(player);
        ...
        it('Should redeem all Athenians without Persian slaves', async function () {
            let player = athenian_1;
            // Check balances
            let currentPersiansBalance = await persians.balanceOf(player);
            let currentSpartansBalance = await spartans.balanceOf(player);
    ...
    describe("It\'s a draw!", async function () {
        ...
        ******************************************************************************/
        ...
        it('Should redeem survived Persian warriors without Spartan slaves', async function () {
            let player = persian_1;
            // Check balances
            let currentPersiansBalance = await persians.balanceOf(player);
            let currentSpartansBalance = await spartans.balanceOf(player);
        ...
        it('Can\'t redeem survived Persian warriors twice', async function () {
            let player = persian_1;
            // Redeem warriors again
            let redeem = await battle.redeemWarriors({ from: player });
            assert(redeem, 'Redeem failed');
        ...
        it('Can\'t redeem Immortal warriors twice', async function () {
            let player = immortal_1;
            // Redeem warriors again        
            let redeem = await battle.redeemWarriors({ from: player });
            assert(redeem, 'Redeem failed');
        ...
        it('Should redeem survived Spartan warriors without Persian slaves', async function () {
            let player = spartan_1;
            // Check balances
            let currentSpartansBalance = await spartans.balanceOf(player);
            let currentPersiansBalance = await persians.balanceOf(player);
        ...
        it('Can\'t redeem Spartan warriors twice', async function () {
            let player = spartan_1;
            // Redeem warriors again        
            let redeem = await battle.redeemWarriors({ from: player });
            assert(redeem, 'Redeem failed');
        ...
        it('Can\'t redeem Athenian warriors twice', async function () {
            let player = athenian_1;
            // Redeem warriors again        
            let redeem = await battle.redeemWarriors({ from: player });
            assert(redeem, 'Redeem failed');
        ...
        it('Should redeem survived Persians, survived Spartan, all Immortals and all Athenians', async function () {
            let player = all_warriors_1;
            // Check balances
            let currentPersiansBalance = await persians.balanceOf(player);
            let currentSpartansBalance = await spartans.balanceOf(player);
        ...
        it('Can\'t redeem survived Persians, survived Spartan, all Immortals and all Athenians twice', async function () {
            let player = all_warriors_1;
            // Redeem warriors again        
            let redeem = await battle.redeemWarriors({ from: player });
            assert(redeem, 'Redeem failed');
